...
<head>
  ...
  <title>VidView | Create Admin</title>
  ...
  <div class="flex-1 flex flex-col md:ml-60">
    ...
    <main class="flex-1 p-6 space-y-6">
      ...
      <form action="${pageContext.request.contextPath}/admin/admin" method="POST" class="bg-gray-900 border border-sky-700/30 shadow-lg rounded-xl p-8 w-full">
        ...
        <h2 class="text-2xl font-semibold text-sky-400 mb-6"><i class="fas fa-user-shield mr-2"></i> Create New Admin</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input type="email" id="email" name="email" required
              class="w-full px-4 py-2 rounded-lg border border-gray-700 bg-gray-800 text-white focus:ring-2 focus:ring-sky-500 focus:outline-none"
              placeholder="e.g., alex@vidview.com">
          </div>
        </div>
        ...
        <div class="mt-6">
          ...
          <input type="password" id="password" name="password" required
            class="w-full px-4 py-2 rounded-lg border border-gray-700 bg-gray-800 text-white focus:ring-2 focus:ring-sky-500 focus:outline-none"
            placeholder="Enter a strong password" oninput="validatePassword()">

          <!-- Password Requirements -->
          <div class="text-sm mt-2 space-y-1" id="passwordCriteria">
